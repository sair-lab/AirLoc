...
def preprocess(configs):
    ...
    for dataset in datasets:
        ...
        for scene in os.listdir(dataset_path):
            ...
            if split:
                if save_pkl:
                    with open(os.path.join(pkl_path,scene+"_train.pkl"), "wb") as out_file:
                        pickle.dump(train_data, out_file)
                    with open(os.path.join(pkl_path,scene+"_test.pkl"), "wb") as out_file:
                        pickle.dump(test_data, out_file)

            else:
                if save_pkl:
                    with open(os.path.join(pkl_path,scene+".pkl"), "wb") as out_file:
